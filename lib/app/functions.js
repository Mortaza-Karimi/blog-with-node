...
async function generateCategories() {
  ...
  const categoriesList = await categories.showCategories();
...
async function generateCategoryArticles() {
  ...
  const categoryArticlesList = await categories.showByCategories(
    `${categoryName}`
  );
...
async function generateTags() {
  ...
  const tagsList = await tags.showTags();
...
async function generateTagArticles() {
  ...
  const tagArticlesList = await categories.showByCategories(`${tagName}`);
...
async function generateYears() {
  ...
  const yearsList = await years.showYears();
...
async function generateYearArticles() {
  ...
  const yearArticlesList = await years.showByYear(`${yearName}`);
...
async function generateMonths() {
  ...
  const monthsList = await months.showMonths();
...
async function generateMonthArticles() {
  ...
  const monthArticlesList = await months.showByMonth(
    `${monthName.split("%20/%20")[0]}`,
    `${monthName.split("%20/%20")[1]}`
  );
